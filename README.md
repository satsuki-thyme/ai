...
- project/comprehensive/etc/project-instructions.md:                      プロジェクトの指示（総合）
- project/novel-creation/etc/consultation.toml:                           相談内容（小説制作）
- project/novel-creation/etc/project-instructions.md:                     プロジェクトの指示（小説制作）
